...
open class Application : CommandLineRunner {
    ...
    override fun run(vararg args: String?) {
        ...
        testBeanConfigure.traceMarkInfo()
        testBeanConfigure.debugMarkInfo()
        testBeanConfigure.infoMarkInfo()
        testBeanConfigure.warnMarkInfo()
        testBeanConfigure.errorMarkInfo()
        Assert.assertEquals(
