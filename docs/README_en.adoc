= image:../logo.svg[Boat Spring Boot] Boat Spring Boot: SrcLab Core Libraries for Spring Boot and {boat-url}[Boat]
:toc:
:toclevels: 3
:last-update-label!:
...
[source,java]
----
include::../boat-spring-boot-sample/src/test/java/sample/java/xyz/srclab/spring/boot/exception/RuntimeExceptionHandler.java[]
----

[source,java]
----
include::../boat-spring-boot-sample/src/test/java/sample/java/xyz/srclab/spring/boot/exception/ThrowableHandler.java[]
----
...
* `EnableWebExceptionService`: Annotation to enable global web exception service;
