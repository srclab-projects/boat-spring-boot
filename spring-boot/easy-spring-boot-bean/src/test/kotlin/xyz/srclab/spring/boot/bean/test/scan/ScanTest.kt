...
class ScanTest : AbstractTestNGSpringContextTests() {
    ...
    fun testBeanScanner() {
        ...
        val scanner3 = BeanScanner.newBuilder().includeAll()
            .excludeFilter(TypeFilter { metadataReader: MetadataReader, _: MetadataReaderFactory ->
        ...
        val scanner4 = BeanScanner.newBuilder().includeAll()
            .excludeFilters(TypeFilter { metadataReader: MetadataReader, _: MetadataReaderFactory ->
                metadataReader.classMetadata.className == SomeClass::class.java.name
            }, TypeFilter { metadataReader: MetadataReader, _: MetadataReaderFactory ->
